...
<body>
	<div id="registrace_cele">
		...
		<form method="POST" action="registrace_action.php">
			...
			<input type="text" name="uzivatel" placeholder="Uzivatelske jmeno" id="input_uzivatel" class="tlacitka_registrace"><br>
			...
			<a href="../index.php" id="odkaz">Pokud uz ucet mas, tady se prihlasis</a>
		</form>
	</div>
</body>
</html>